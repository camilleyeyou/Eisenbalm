...
- [ ] 28-03-scoring-endpoint-contract-first-PLAN.md — Wave 1: API_CONTRACTS §3A.2 (contract-first) + standalone `score_output` scorer (active rubric, disk fallback) + `POST /agents/{key}/score` + pytest (PRC-09 backend)
