...
| DEL-06 | Agent identity card links to `/agents/[agentId]` (route exists, no 404) | unit + manual | `cd apps/web && npm run test:unit -- __tests__/deliberation-agent-cards.test.ts` | ✅ (Plan 09-00) | ⬜ pending | Plan 09-02 (chip href) + Plan 09-03 (route) |
...
## Wave 0 Requirements (all authored in Plan 09-00)
...
- [x] Wave 0 covers all MISSING references (7 new test files authored in Plan 09-00)
- [x] No watch-mode flags (use `vitest run`, never `vitest` watch)
- [x] Feedback latency < ~10s
- [x] `nyquist_compliant: true` set in frontmatter

**Approval:** planner-confirmed 2026-05-21
