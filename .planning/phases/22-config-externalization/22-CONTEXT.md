...
- `packages/pipeline/src/eisenbalm_pipeline/lib/llm_config.py` — `MODEL_BY_AGENT`, `SAMPLING_BY_AGENT`, `MAX_TOKENS_BY_AGENT`, `MODEL_PIN_VOICE_CRITICAL` (the fallback default set; source for the `agents` seed).
