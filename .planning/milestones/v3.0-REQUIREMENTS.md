<!--
ARCHIVE — Milestone v3.0 Dispatch Control v2 (Editorial Operator Console)
Frozen snapshot taken 2026-07-10 at milestone completion.
This is a point-in-time copy of the cumulative REQUIREMENTS.md. The live
.planning/REQUIREMENTS.md is intentionally NOT deleted — it is cumulative
(v1 + v2.0 + v3.0 + deferred/future) and carries forward to the next milestone.
All v3.0 requirement blocks (CHR, GLY, EDT, PUB, VOX, PRV, MON, SIG, EVL, MEM)
were checked complete at archive time.
-->
