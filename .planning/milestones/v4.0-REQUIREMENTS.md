# Requirements Archive — v4.0 (Dispatch Control v3 — The Editorial Workspace)

**Status:** ✅ SHIPPED 2026-07-17

**Frozen snapshot** of REQUIREMENTS.md at v4.0 completion; the master REQUIREMENTS.md continues to accumulate.
