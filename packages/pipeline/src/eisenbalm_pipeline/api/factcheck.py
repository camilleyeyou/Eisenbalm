"""Phase 42 (FCT-05, docs/API_CONTRACTS.md §42.4) — Fact Check claim action
endpoints.

Four Clerk-JWT-guarded routes covering the non-evidence claim actions
(Task 2 of this plan adds the two-step "Ask agent for better evidence"
evidence/preview + evidence/apply pair, FCT-06):
