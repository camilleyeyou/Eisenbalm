<!--
  Eisenbalm Dispatch — QA Judge rubric (externalized)
  Byte-source-of-truth for agents/qa/rubric.md. load_prompt("rubric")
  must equal that file byte-for-byte (incl. its single trailing newline).
