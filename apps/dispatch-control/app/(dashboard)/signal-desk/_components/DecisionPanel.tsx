'use client'
/**
 * Phase 37 (SIG-02, Plan 37-05 Task 2) — DecisionPanel: the story-decision
 * winner + confidence meter + editor reasoning, sourced from the `editor-decision`
    ...
    >
      ...
      {rows === undefined ? (
        ...
        <p className="mt-2 text-[13px] italic text-[color:var(--color-ink-soft)]">
          No decision yet — the story hasn&rsquo;t been chosen.
        </p>
      ) : (
        (() => {
              ...
              {confidencePct != null && (
                <div className="mt-2">
                  ...
                  <div
                    ...
                    aria-valuemin={0}
                    aria-valuemax={100}
                    aria-label="Story decision confidence"
                  >
                    <div
